...
#############step3##########在每一个数据库里面（COG,pfam,PRK,TIGR）挑选一个e value最小的accession#
open my $fh1,"../result/Cu_result_samples226/hitdata_0721_delCd.txt" or die $!;
open my $out,">../result/Cu_result_samples226/hitdata_0721_delCd_min.txt" or die $!;
my %hash;
my %hash_e;
my %hash_acc;
while(<$fh1>){
