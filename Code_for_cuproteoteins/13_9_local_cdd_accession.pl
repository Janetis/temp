...
########################
open my $fh,"../result/Cu_result_samples226/hitdata_0721_delCd_sec_min_sort_min.txt" or die $!;
open my $out,">../result/Cu_result_samples226/hitdata_0721_delCd_sec_min_match.txt" or die $!;
while(<$fh>){
	s/\v//g;
	my @line = split("\t",$_);
