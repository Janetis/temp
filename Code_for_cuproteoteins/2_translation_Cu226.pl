...
open my $out,">../result/Cu_result_samples226/length50more_ppos20more_0721_all_result.txt" or die $!;
...
##提取出文件名
	...
	open my $fh2,"../result/Cu_result_samples226/tblastn_Cu_226arr_result/$myfile/${myfile}_20170721.out" or die $!;
